 ...
 * @author Wouter
 */
public class HostCharactersPanel extends javax.swing.JPanel {

  private static final Logger log = LoggerFactory.getLogger(HostCharactersPanel.class);

  private static final Settings SETTINGS = Settings.getInstance();
  private static final String DIVIDER_LOCATION_PROPERTY_FORMAT = "gui.host.presetpanel.%s.deviderlocation";
  ...
  public HostCharactersPanel(Class<? extends AbstractCharacter> characterClass) {
    this(characterClass, "Previous", "Next");
  }

  public HostCharactersPanel(Class<? extends AbstractCharacter> characterClass, String previous, String next) {
  ...
  private void initComponents() {
    ...
    spPreset.setBorder(javax.swing.BorderFactory.createLineBorder(null));
