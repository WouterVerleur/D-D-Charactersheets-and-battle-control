 ...
 */
package org.dndbattle.view.host.character.extendedCharacter;
...
public class ExtendedCharacterPanel extends javax.swing.JPanel implements IUpdateablePanel {
    ...
    private void initComponents() {
        ...
        tfPlayerName.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfPlayerNameFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        tfRace.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfRaceFocusLost(evt);
            }
        });
        ...
        tfBackground.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfBackgroundFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        tfAlignment.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfAlignmentFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        bExperiencePoints.setText("+");
        bExperiencePoints.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bExperiencePointsActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        tfEyes.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfEyesFocusLost(evt);
            }
        });
        ...
        tfSkin.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfSkinFocusLost(evt);
            }
        });
        ...
        tfHair.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfHairFocusLost(evt);
            }
        });
        ...
        taProficiencies.setOpaque(false);
        ...
        taPersonalityTraits.setOpaque(false);
        ...
        taEquipment.setToolTipText("This field is disabled and will be removed in future versions. Please use the equipment tab.");
        taEquipment.setWrapStyleWord(true);
        taEquipment.setEnabled(false);
        taEquipment.setOpaque(false);
        ...
        taAlliesAndOrganisations.setOpaque(false);
    ...
    private void tfPlayerNameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfPlayerNameFocusLost
        ...
        saveCharacter();
    }//GEN-LAST:event_tfPlayerNameFocusLost

    private void tfRaceFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfRaceFocusLost
        character.setRace(tfRace.getText());
        saveCharacter();
    }//GEN-LAST:event_tfRaceFocusLost

    private void tfBackgroundFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfBackgroundFocusLost
        character.setBackground(tfBackground.getText());
        saveCharacter();
    }//GEN-LAST:event_tfBackgroundFocusLost

    private void tfAlignmentFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfAlignmentFocusLost
        character.setAlignment(tfAlignment.getText());
        saveCharacter();
    }//GEN-LAST:event_tfAlignmentFocusLost
    ...
    private void tfEyesFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfEyesFocusLost
        character.setEyes(tfEyes.getText());
        saveCharacter();
    }//GEN-LAST:event_tfEyesFocusLost

    private void tfSkinFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfSkinFocusLost
        character.setSkin(tfSkin.getText());
        saveCharacter();
    }//GEN-LAST:event_tfSkinFocusLost

    private void tfHairFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfHairFocusLost
    ...
    private void bExperiencePointsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bExperiencePointsActionPerformed
        ...
        if (input != null) {
            try {
                ...
                log.error("Error parsing user input [{}] to integer", e);
            }
        }
        saveCharacter();
