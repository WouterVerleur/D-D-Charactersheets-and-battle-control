...
import static org.dndbattle.utils.Settings.HOST_SIZE_HEIGHT;
import static org.dndbattle.utils.Settings.HOST_SIZE_STATE;
import static org.dndbattle.utils.Settings.HOST_SIZE_WIDTH;
import static org.dndbattle.utils.Settings.HOST_TITLE;
...
import org.dndbattle.core.impl.HostConnectionInfo;
...
public class HostFrame extends javax.swing.JFrame {
  ...
  private static final Logger log = LoggerFactory.getLogger(HostFrame.class);
  ...
  private void setSizeAndLocation() {
    setLocation(SETTINGS.getProperty(HOST_LOCATION_X, Integer.MIN_VALUE), SETTINGS.getProperty(HOST_LOCATION_Y, Integer.MIN_VALUE));
    setSize(SETTINGS.getProperty(HOST_SIZE_WIDTH, getPreferredSize().width), SETTINGS.getProperty(HOST_SIZE_HEIGHT, getPreferredSize().height));
  ...
  private void initComponents() {
    ...
    pAudio = new org.dndbattle.view.host.AudioPanel();
    spDice = new javax.swing.JScrollPane();
    dicePanel = new org.dndbattle.view.host.DicePanel();
    ...
    pArmors = new org.dndbattle.view.host.armor.ArmorsPanel();
    pSpells = new org.dndbattle.view.host.spells.SpellsPanel();
    pWeapons = new org.dndbattle.view.host.weapons.WeaponsPanel();
    pUtilities = new org.dndbattle.view.host.utilities.UtilitiesPanel();
    pEncounterCalculator = new org.dndbattle.view.host.encounter.EncounterCalculator();
    ...
    setTitle(SETTINGS.getProperty(HOST_TITLE, "Host"));
    ...
    pMain.add(bAddCombatant, gridBagConstraints);
    ...
    gridBagConstraints.insets = new java.awt.Insets(5, 5, 0, 0);
    pMain.add(bNext, gridBagConstraints);
    ...
    pMain.add(bNewBattle, gridBagConstraints);
    ...
    miBattleView.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_B, java.awt.event.InputEvent.ALT_DOWN_MASK));
    ...
    miBattleNext.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_SPACE, java.awt.event.InputEvent.CTRL_DOWN_MASK));
    ...
    miBattleNew.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.CTRL_DOWN_MASK));
    ...
    miBattleAdd.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.CTRL_DOWN_MASK));
    ...
    miShutdown.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F4, java.awt.event.InputEvent.ALT_DOWN_MASK));
    ...
    if (getExtendedState() == NORMAL) {
      SETTINGS.setProperty(HOST_SIZE_HEIGHT, getHeight());
      SETTINGS.setProperty(HOST_SIZE_WIDTH, getWidth());
    }
    if (getExtendedState() != ICONIFIED) {
      SETTINGS.setProperty(HOST_SIZE_STATE, getExtendedState());
    }
    ...
    switch (JOptionPane.showConfirmDialog(this,
      ...
      case JOptionPane.YES_OPTION:
        List<ICombatant> combatants = host.getCombatants();
  ...
  private synchronized void refreshClientsTable() {
    ...
    model.setRowCount(0);
    for (HostConnectionInfo connectionInfo : host.getClients()) {
      String ip = "Unknown";
      try {
        ip = connectionInfo.isLocalhost() ? "localhost" : connectionInfo.getClient().getIp();
    ...
    if (selectedRow >= 0) {
      host.kick(host.getClients().get(selectedRow));
      refreshClientsTable();
    }
  ...
  private org.dndbattle.view.host.DicePanel dicePanel;
  ...
  private org.dndbattle.view.host.armor.ArmorsPanel pArmors;
  private org.dndbattle.view.host.AudioPanel pAudio;
  private javax.swing.JPanel pCharacters;
  private javax.swing.JPanel pClients;
  private javax.swing.JPanel pCombatants;
  private org.dndbattle.view.host.encounter.EncounterCalculator pEncounterCalculator;
  private javax.swing.JPanel pMain;
  private org.dndbattle.view.host.spells.SpellsPanel pSpells;
  private org.dndbattle.view.host.utilities.UtilitiesPanel pUtilities;
  private javax.swing.JPanel pView;
  private org.dndbattle.view.host.weapons.WeaponsPanel pWeapons;
  ...
  private org.dndbattle.view.host.SettingsPanel settingsPanel;
  ...
  public void refreshBattle(final List<ICombatant> combatants, int activeIndex) {
    ...
    for (ICombatant combatant : characters) {
      if (!combatant.getCharacter().equals(previousCharacter)) {
        tpBattle.add(new ClientCharacterPanel(combatant.getCharacter()));
  ...
  private void addCombatant(Combatant combatant) {
    ...
    pCombatants.add(new HostCombatantPanel(host, combatant));
  }
  ...
  public void resetObjectPanels() {
    ...
    for (Component characterpanel : pCharacters.getComponents()) {
      if (characterpanel instanceof HostCharactersPanel) {
        log.error("Resetting [{}]", characterpanel);
        ((HostCharactersPanel) characterpanel).updateList(true);
      }
    }
  }
  ...
  private class ClassMenuItem extends JMenuItem {
    ...
    private final HostCharactersPanel panel;
    ...
    public ClassMenuItem(Class clazz, String previous, String next) {
      ...
      panel = new HostCharactersPanel(clazz, previous, next);
