...
import static org.dndbattle.utils.Settings.CLIENT_SPELLS_SEPERATOR;
 ...
 * @author Wouter
 */
public class ClientCharacterPanel extends javax.swing.JPanel implements IUpdateablePanel {

  private static final Logger log = LoggerFactory.getLogger(ClientCharacterPanel.class);

  private static final Settings SETTINGS = Settings.getInstance();
  private static final String WEAPON_SELECTION_FORMAT = "gui.client.%s.weapons.selection";
  private static final String EQUIPMENT_SLIDER_SETTING = "gui.client.equipment.slider.location";
  ...
  public ClientCharacterPanel(ICharacter character) {
  ...
  private void initComponents() {
    ...
    tpCharacterPages.addTab("Abilities", new org.dndbattle.view.client.character.ClientAbilityAndSkillPanel(character));
    if (character instanceof IExtendedCharacter){
      tpCharacterPages.addTab("Character", new org.dndbattle.view.client.character.ClientExtendedCharacterPanel((IExtendedCharacter) character));
    }
    ...
    lAbility.setBorder(javax.swing.BorderFactory.createTitledBorder("Ability"));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
    gridBagConstraints.gridy = 0;
    ...
    lSpellcastingAbility.setBorder(javax.swing.BorderFactory.createTitledBorder("Spellcasting Ability"));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 1;
    gridBagConstraints.gridy = 0;
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    lSpellSaveDC.setBorder(javax.swing.BorderFactory.createTitledBorder("Spell Save DC"));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 2;
    gridBagConstraints.gridy = 0;
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    lSpellAttackBonus.setBorder(javax.swing.BorderFactory.createTitledBorder("Spell Attack Bonus"));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 3;
    gridBagConstraints.gridy = 0;
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
  ...
  private void updateEquipment() {
    ...
    character.getInventoryItems().forEach((inventoryItem) -> {
      pEquipmentGrid.add(new ClientInternalEquipmentPanel(inventoryItem));
    });
  }
  ...
  private void updateSpellTable() {
    ...
    if (spells.isEmpty()) {
      ...
      spSpells.setDividerLocation(SETTINGS.getProperty(CLIENT_SPELLS_SEPERATOR, spSpells.getDividerLocation()));
