 ...
 * @author Wouter
 */
public class ClientAbilityPanel extends javax.swing.JPanel {

  private final AbilityType abilityType;
  private final ICharacter character;

  public ClientAbilityPanel(ICharacter character, AbilityType abilityType) {
  ...
  private void initComponents() {
    ...
    lScore.setText(Integer.toString(character.getAbilityScore(abilityType)));
