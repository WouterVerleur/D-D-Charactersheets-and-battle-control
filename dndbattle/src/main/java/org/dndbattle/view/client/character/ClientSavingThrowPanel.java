 ...
 * @author Wouter
 */
public class ClientSavingThrowPanel extends javax.swing.JPanel {

  private final AbilityType abilityType;
  private final ICharacter character;

  public ClientSavingThrowPanel(ICharacter character, AbilityType abilityType) {
  ...
  private void initComponents() {
    ...
    setBorder(javax.swing.BorderFactory.createTitledBorder(abilityType.getFullName()));
    ...
    lProficiency.setText(character.getSavingThrowProficiency(abilityType).toString());
