...
public class AbilityPanel extends javax.swing.JPanel implements IUpdateablePanel {
    ...
    public final void update() {
        ...
        String modString = modifier > 0 ? "+" + modifier : Integer.toString(modifier);
        if (character.isJackOfAllTrades()) {
            int jackScore = modifier + Math.floorDiv(character.getProficiencyScore(), 2);
            lModifier.setText(modString + " (" + (jackScore > 0 ? "+" + jackScore : Integer.toString(jackScore)) + ")");
        } else {
            lModifier.setText(modString);
        }
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(sScore, javax.swing.GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE)
        );
