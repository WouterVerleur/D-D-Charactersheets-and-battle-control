...
public class MasterCombatantPanel extends javax.swing.JPanel {
    ...
    private static final String DEATH_ROLL = "Add death roll (%d)";
    private static final String LIFE_ROLL = "Add life roll (%d)";
    ...
    private void initComponents() {
        ...
        bDeathRoll.setText(String.format(DEATH_ROLL,combatant.getDeathRolls()));
        ...
        bLifeRoll.setText(String.format(LIFE_ROLL,combatant.getLifeRolls()));
