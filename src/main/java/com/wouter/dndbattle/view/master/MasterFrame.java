...
public class MasterFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        spellsPanel1 = new com.wouter.dndbattle.view.master.spells.SpellsPanel();
        weaponsPanel1 = new com.wouter.dndbattle.view.master.weapons.WeaponsPanel();
        ...
        pView.add(spellsPanel1, "Spells");
        pView.add(weaponsPanel1, "Weapons");
    ...
    private com.wouter.dndbattle.view.master.spells.SpellsPanel spellsPanel1;
    private javax.swing.JTable tClients;
    private javax.swing.JTabbedPane tpBattle;
    private com.wouter.dndbattle.view.master.weapons.WeaponsPanel weaponsPanel1;
    ...
    private void addItemsToMCharacters() {
        for (Class clazz : ClassComboBox.getAllClasses()) {
            mCharacters.add(new ClassMenuItem(clazz));
        }
    }
    ...
    private class ClassMenuItem extends JMenuItem {
        ...
        public ClassMenuItem(Class clazz) {
            String name = clazz.getSimpleName();
            setName(name);
            setText(name);

            panel = new MasterCharactersPanel(clazz);
